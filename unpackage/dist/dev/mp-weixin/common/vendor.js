...
function initData(vueOptions, context) {
  ...
  if (typeof data === 'function') {
    try {
      ...
      if (Object({"VUE_APP_NAME":"YunCangKu","VUE_APP_PLATFORM":"mp-weixin","NODE_ENV":"development","BASE_URL":"/"}).VUE_APP_DEBUG) {
...
/***/ 18:
/*!************************************************!*\
  !*** D:/云仓库小程序/YunCangKu/baseservices/http.js ***!
  \************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

var storage = __webpack_require__(/*! ../utils/storage.js */ 19).default;
var common = __webpack_require__(/*! ../baseservices/common.js */ 20);
// const app = getApp()
var http = {
  httpPost: function httpPost(url, data, success, fail)
  {
    // 获取接口地址
  ...
  httpGet: function httpGet(url, data, success, fail)
  {
  ...
  httpAuthPost: function httpAuthPost(url, ticket, data, _success, _fail)
  {
    // 获取接口地址
    var baseUrl = this.getBaseUrl(url);
    wx.request({
  ...
  httpAuthGet: function httpAuthGet(url, ticket, data, _success2, _fail2)
  {
    // 获取接口地址
    var baseUrl = this.getBaseUrl(url);
    wx.request({
  ...
  //同步方法
  httpAuthGetSync: function httpAuthGetSync(url, ticket, data) {var _this = this;
    return new Promise(function (resolve, reject) {
      // 获取接口地址
      var baseUrl = _this.getBaseUrl(url);
      wx.request({
        url: baseUrl,
        data: data,
        method: 'get',
  ...
  httpAutoAuthGet: function httpAutoAuthGet(url, data, _success3, _fail3, aler)
  {
  ...
  /**
      ...
      * */
  httpAutoAuth: function httpAutoAuth(method, url, data, _success4, _fail4, aler)
  {
  ...
  getBaseUrl: function getBaseUrl(url) {
    if (url && !(url.indexOf('http') == 0)) {
      var app = getApp();
      var _baseUrls = [common.config.apilist.GetAdListson, common.config.apilist.GetAdInfoJson];
      var baseUrl = common.config.ApiUrl;
...
/***/ 19:
/*!********************************************!*\
  !*** D:/云仓库小程序/YunCangKu/utils/storage.js ***!
  \********************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

"use strict";
Object.defineProperty(exports, "__esModule", { value: true });exports.default = void 0;var storage = {
  /**
                                                                                                                     * 设置本地缓存数据
  ...
  setItem: function setItem(key, data, success, fail, complete) {
    wx.setStorage({
      key: key,
      data: data,
      success: success,
  ...
  getItem: function getItem(key, success, fail, complete) {
    wx.getStorage({
      key: key,
      success: success,
      fail: fail,
  ...
  /**
      ...
      * @callback complete 完成后的回调 不是必填
      */
  removeItem: function removeItem(key, success, fail, complete) {
    wx.removeStorage({
      key: key,
      success: success,
      fail: fail,
  ...
  /**
      ...
      * @param {*} data 要设置的值 必填
      */
  setSyncItem: function setSyncItem(key, value) {
    if (!key) {
      return;
    }
    try {
  ...
  /**
      ...
      * @param {String} key 键 必填
      */
  getSyncItem: function getSyncItem(key) {
    if (!key) {
      return "";
    }
    try {
...
/***/ 20:
/*!**************************************************!*\
  !*** D:/云仓库小程序/YunCangKu/baseservices/common.js ***!
  \**************************************************/
/*! no static exports found */
/***/ (function(module, exports) {

//资源图片地址
var ApiUrl = "https://shop.myzhyp.com/api";
var branchApiUrl = "https://shop.myzhyp.com/fxapi";
// 总店接口地址
var serverUrl = "https://car.xmtyqp.com/";
// serverUrl =  "https://car.xmtyqp.com";
// 分支版本
var branchUrl = "https://fxcar.xmtyqp.com:444";
